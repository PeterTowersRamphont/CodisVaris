...
GDP \<- read_excel("C:/Users/Iván/Documents/Trabajo/PD_series/data0/GDP24.xls",
...
# status: updated
GDP <- read_excel("C:/Users/Iván/Documents/Trabajo/PD_series/data/GDP.xls", 
     sheet = "SAS", col_types = c("date", "numeric"))
#GDP$Date <- as.Date(as.yearqtr(GDP$Date, format = '%Y Q%q')) -1
GDP$Date <- as.Date(GDP$Date)

# satus: updated
UR <- read_excel("C:/Users/Iván/Documents/Trabajo/PD_series/data/UR.xls", 
     sheet = "SAS", col_types = c("date", "numeric"))
UR$Date <- as.Date(UR$Date)

# satus: updated
MACRO_IND <- read_excel("C:/Users/Iván/Documents/Trabajo/PD_series/data/datos UK.xlsX", 
     sheet = "SAS", col_types = c("date", "numeric", "numeric", "numeric", "numeric"))
MACRO_IND$Dates <- as.Date(MACRO_IND$Dates) 

# satus: updated
CPIH <- read_excel("C:/Users/Iván/Documents/Trabajo/PD_series/data/CPIH.xls", 
     sheet = "SAS", col_types = c("text", "numeric"))
CPIH$Date <- as.Date(as.yearqtr(CPIH$Date, format = '%Y Q%q')) -1

# satus: updated
GDI <- read_excel("C:/Users/Iván/Documents/Trabajo/PD_series/data/Deuda y RBD hogares.xlsx", 
...
df <- df[order(df$Date), ]
write_xlsx(df, "C:/Users/Iván/Documents/Trabajo/PD_series/outputs/df_baseline_new.xlsx")
```
...
write_xlsx(corr_df, "C:/Users/Iván/Documents/Trabajo/PD_series/outputs/corr_macro_new.xlsx")
```
...
write_xlsx(corr_df, "C:/Users/Iván/Documents/Trabajo/PD_series/outputs/corr_excl_covid_new.xlsx")
```
...
write_xlsx(series_0, "C:/Users/Iván/Documents/Trabajo/PD_series/outputs/series0_new.xlsx")
...
write_xlsx(smoothings_df, "C:/Users/Iván/Documents/Trabajo/PD_series/outputs/smoothings_new.xlsx")
...
write_xlsx(filterings_df, "C:/Users/Iván/Documents/Trabajo/PD_series/outputs/filterings_new.xlsx")
```
...
# Export to Excel
write_xlsx(as.data.frame(smoothings), "C:/Users/Iván/Documents/Trabajo/PD_series/outputs/smoothed series.xlsx")
write_xlsx(series, "C:/Users/Iván/Documents/Trabajo/PD_series/outputs/input series.xlsx")
write_xlsx(plotting_ds, "C:/Users/Iván/Documents/Trabajo/PD_series/outputs/Synthetic GDPs (quarterly rates) UR, Employed, Business Income.xlsx")
```
